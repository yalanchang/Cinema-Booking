              ...
              {!isEditing ? (
                <div>
                  ...
                  <button
                    ...
                    className="mt-4 px-4 py-2 bg-[#D26900] hover:bg-[#C25A00] text-white rounded-xs transition-colors"
                  >
                    編輯個人資訊
                  </button>
                </div>
                ...
                <div className="flex-1">
                  <div className="mb-4">
                    <label className="block text-sm text-gray-300 mb-2">名字</label>
                    <input
                      type="text"
                      name="name"
                      value={formData.name}
                  ...
                  <div className="mb-4">
                    <label className="block text-sm text-gray-300 mb-2">電話</label>
                    <input
                      type="tel"
                      name="phone"
                  ...
                  <div className="flex gap-3">
                    <button
                      onClick={handleSave}
                      disabled={isSaving}
                      className="px-4 py-2 bg-[#D26900] hover:bg-[#C25A00] disabled:bg-gray-600 text-white rounded-xs transition-colors"
                    >
                      {isSaving ? '保存中...' : '保存'}
                    </button>
                    <button
                      ...
                      disabled={isSaving}
                      className="px-4 py-2 bg-gray-700 hover:bg-gray-600 disabled:bg-gray-600 text-white rounded-xs transition-colors"
                    >
                      取消
                    </button>
                  </div>
